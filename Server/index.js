        ...
        if (response !== null) {
            ...
            bcrypt.compare(req.body.password, password, (err, result) => {
                if (result) {
                    ...
                    res.cookie("username",req.body.username,{sameSite:"none",secure:true,domain:process.env.CLIENT_DOMAIN}).cookie("accessToken",accessToken,{httpOnly:true,secure:true,sameSite:"none",domain:process.env.CLIENT_DOMAIN}).send({ msg: "User logged in"})
